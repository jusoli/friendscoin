...
unlocked to sign the Friendscoin-Qt.app bundle.
...
allowing somebody to distribute a Friendscoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the friendscoin-qt.exe file inside the installer had not been tampered with.
